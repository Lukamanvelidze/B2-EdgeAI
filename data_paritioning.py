...
def partition_and_copy(pairs, base_folder, num_parts, split_type):
    ...
    for i in range(num_parts):
        ...
        img_dir = create_dir(os.path.join(part_folder, 'images'))
        lbl_dir = create_dir(os.path.join(part_folder, 'labels'))
...
if __name__ == "__main__":
    ...
    split_dataset_within_each_cxx(dataset_root, train_ratio=0.8, num_partitions=6)
